...
MOCK_RESPONSES = {
    ...
    "jwt": ["JWT là JSON Web Token, dùng để xác thực người dùng mà không cần lưu session phía server."],
    "redis": ["Redis là in-memory data store, dùng để lưu session, cache, và rate limit counter."],
    "scale": ["Scaling là tăng số lượng instances để xử lý nhiều requests hơn. Stateless design giúp scale dễ dàng."],
}
